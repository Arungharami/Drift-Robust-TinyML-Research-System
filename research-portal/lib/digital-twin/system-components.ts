...
export function buildSystemComponents(): SystemComponent[] {
  ...
  const components: SystemComponent[] = [
    ...
    },
    {
      ...
      group: "edge",
      stage: 10,
      description: "Weights-only INT8 quantization protocol frozen (GATE-C1-INT8-QUANT-001); not yet executed.",
      ...
      statusNote: "A weights-only, per-tensor symmetric INT8 mapping and byte-count estimate are frozen as a specification; quantization itself has not been executed at any tier.",
      dependencies: ["machine-learning"],
      evidenceLinks: [
        { label: "Embedded equivalence protocol", path: "configs/embedded_equivalence_protocol.yaml" },
        { label: "C1 INT8 quantization protocol", path: "docs/embedded/C1_INT8_QUANTIZATION_PROTOCOL.md" },
      ],
      pipelineIds: ["13", "14", "14R", "14F-GATE", "14F-EXEC", "14F-XAI", "14Q-GATE"],
      portalHref: "/tinyml",
